...
export const showModal = async (err, data) => {
  ...
  `
	...
	labelDescription.classList.add(
		'crm-wrapper__title',
	...
	textareaDescription.classList.add(
		'crm-wrapper__textarea',
		'crm__descpiption-textarea',
		'elem-form-validate-text'
	);
	...
	fieldsetCrmDiscountInner.append(
		inputDiscountChecbox,
		labelDiscountInner,
		inputDiscountInner
	);
	...
	if (data) {
		imgCard.src = `https://mica-short-xenoposeidon.glitch.me/${data.image}`;
